...
for(j in 1:kcv){
  ...
  for(i in 1:100){
    ...
    near = kknn(churn ~ custcare_Mean + mou_Mean + mou_cvce_Mean + lor + change_mou + totmrc_Mean + 
                hnd_price + eqpdays + ovrrev_Mean + vceovr_Mean + uniqsubs + ovrmou_Mean + roam_Mean,
